...
<template>
  <div class="bg-black/30 h-screen w-full overflow-y-auto overflow-x-hidden fixed z-50 justify-center items-center">
    <div
      ...
      <div class="relative rounded-lg bg-managray-100/10 backdrop-blur-md shadow-2xl w-full">
        ...
        <div class="py-6 px-6 lg:px-8">
          ...
          <form class="grid grid-cols-2 w-full space-x-8 justify-center ">
            <div class="space-y-8">
              ...
              <div v-else>
                <label for="email" class="block mb-3 text-sm font-medium text-neutral-300">Email</label>
                <div class="border text-sm rounded-lg block w-full p-2.5 bg-gray-600 border-gray-500 text-gray-400">
            ...
            <div class="space-y-8 w-full">
              ...
              <div>
                ...
                <div className="h-[40px] flex items-start text-sm">
                  ...
                  <span v-if="creatingBooking.file"
                    className="text-white p-2 rounded-lg">{{ creatingBooking.file.name }}</span>
