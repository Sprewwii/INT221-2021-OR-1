...
<template>
  <div
    class="grid gap-10 grid-cols content-center w-full mb-8 sm:grid-cols-2 lg:grid-cols-3 lg:ml-20 lg:mr-20 sm:mt-6 sm:mb-32 mx-auto justify-center justify-self-center">
    <div
