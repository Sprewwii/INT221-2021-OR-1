  ...
  <div class="">
    <div class="relative inline-block">
      <div class="flex space-x-2">
        ...
        class="relative z-10 w-60 flex items-center justify-center py-2 text-sm text-center text-white background-gray border border-manapurple-100 rounded-md">
      ...
      <button @click="toggleFilterList()"
        class="relative z-10 w-40 flex items-center justify-between py-3 pl-2 text-sm text-center text-manapurple-100 outline outline-1 outline-manapurple-100 border border-transparent rounded-md hover:bg-manapurple-100 hover:text-white">
      ...
      <div v-show="showFilterList"
        ...
        <div v-show="showFilterTab === 5" class="w-64 h-80 z-50" @mouseover="showFilterTab = 5"
          @mouseleave="showFilterTab = 0">
