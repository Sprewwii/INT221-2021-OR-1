                ...
                <div class="py-6 px-6 lg:px-8">
                    ...
                    <form class="space-y-6" >
                        <div>
                            ...
                            <input v-model="addingEvent.name" type="text" name="name" id="name"
                        ...
                        <div>
                            ...
                            <input v-model="addingEvent.email" type="email" name="email" id="email"
                                class="border text-sm rounded-lg focus:ring-pink-500 focus:border-pink-500 block w-full p-2.5 bg-gray-600 border-gray-500 placeholder-gray-400 text-white"
                        ...
                        <div>
                            <label for="category" class="block mb-2 text-sm font-medium text-gray-300">Choose Event Category</label>
                            <div class="flex">
                                ...
                                <div
                                    ...
                                    <p v-else class="select-none" >{{ addingEvent.category.categoryDuration }} minutes</p>
                                </div>
                            </div>
                        </div>
