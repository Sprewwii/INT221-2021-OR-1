                ...
                <div class="py-12 lg:py-6 px-6 lg:px-8 h-full max-h-screen overflow-y-auto">
                    ...
                    <form class="space-y-6">
                        <div>
                            ...
                            <input v-model="creatingUser.name" type="text" name="name" id="nameUser"
                            ...
                            <p v-if="showWarning.isName" class="text-[12px] text-red-400 absolute mt-1">* Enter your
                                name.
                            </p>
                            <p v-else-if="showWarning.isNameNotUnique" class="text-[12px] text-red-400 absolute mt-1">*
                            ...
                            <div v-if="creatingUser.name" class="flex justify-end">
                                <p :class="{ 'text-red-400': !validation.validateLength(creatingUser.name, 100) }"
                                    class="text-[12px] text-gray-500 absolute mt-1">{{ creatingUser.name.length }}/100
                                </p>
                            </div>
                        </div>
                        ...
                        <div>
                            <label for="password"
                                class="block mb-1 text-sm font-medium text-neutral-300">Password</label>
                            ...
                            <p v-show="showWarning.isPassword" class="text-[12px] text-red-400 absolute mt-1">* Password
                            ...
                            <div v-if="creatingUser.password" class="flex justify-end">
                                <p :class="{ 'text-red-400': !validation.validateLength(creatingUser.password, 14) }"
                                    class="text-[12px] text-gray-500 absolute mt-1">{{ creatingUser.password.length
                                    }}/14</p>
                            </div>
                        </div>

                        <div>
                            <label for="confirmPassword" class="block mb-1 text-sm font-medium text-neutral-300">Confirm
                                Password</label>
                            <input v-model="creatingUser.confirmPassword" type="password" name="confirmPassword"
                                id="confirmPassword"
                            ...
                            <p v-if="showWarning.isConfirmPassword" class="text-[12px] text-red-400 absolute mt-1">*
                                Confirm password must have 8-14 characters.
                            </p>
                            <p v-else-if="showWarning.matchPassword" class="text-[12px] text-red-400 absolute mt-1">*
                            ...
                            <div v-if="creatingUser.confirmPassword" class="flex justify-end">
                                <p :class="{ 'text-red-400': !validation.validateLength(creatingUser.confirmPassword, 14)}"
                                    class="text-[12px] text-gray-500 absolute mt-1">{{
                                    creatingUser.confirmPassword.length }}/14</p>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <input v-model="creatingUser.email" name="email" id="emailUser" type="text"
                            ...
                            <p v-if="showWarning.isEmail" class="text-[12px] text-red-400 absolute mt-1">* Enter your
                                email.
                            </p>
                        ...
                        <div>
                            ...
                            <span class="text-gray-500 text-xs">If you didn't select any role. Your role will be a
                                student.</span>
