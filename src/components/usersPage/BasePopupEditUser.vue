                    ...
                    <form class="space-y-6">
                        <div>
                            ...
                            <input v-model="editingUser.name"
                                @blur="editingUser.name = editingUser.name.trim(); showWarning.isName = !editingUser.name; validateUniqueName(); "
                        ...
                        <div>
                            ...
                            <input
                                ...
                                @blur="editingUser.email = editingUser.email.trim(); showWarning.isEmail = !editingUser.email; validateEmail(); validateUniqueEmail();">
