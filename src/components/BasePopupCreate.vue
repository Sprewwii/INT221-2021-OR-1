            ...
            <div class="relative rounded-lg shadow bg-gray-800">
                ...
                <div class="py-6 px-6 lg:px-8">
                    ...
                    <form class="space-y-6">
                        ...
                        <div>
                            <label for="email" class="block mb-2 text-sm font-medium text-gray-300">Start Time
                                {{ addingEvent.category ? addingEvent.category.categoryDuration + " " +
                                        addingEvent.duration : ""
                                }}{{ addingEvent.startTime ? new
        Date(addingEvent.startTime).toISOString() : ''
}}</label>
