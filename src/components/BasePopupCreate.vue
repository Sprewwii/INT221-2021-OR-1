              ...
              <div class="space-y-8">
                <div>
                  ...
                  <input
                    ...
                    placeholder="Example OR-1"
                    @blur="showWarning.isName = !creatingBooking.name"
                  />
                  <p
                    v-show="showWarning.isName"
                ...
                <div v-if="userManager.userInfo.role === 'guest' || userManager.userInfo.role === 'admin'">
                  ...
                  />
                  <p
                    v-if="showWarning.isEmail"
                    class="text-sm text-red-400 absolute mt-1"
                  >
                    * Enter your email.
                  </p>
                  <p
                    v-else-if="showWarning.email"
                    class="text-sm text-red-400 absolute mt-1"
                  >
                ...
                <div>
                  <label class="block mb-3 text-sm font-medium text-neutral-300"
                    >Start Time</label
                  >
                  <Datepicker
                    v-model="creatingBooking.startTime"
                    :minDate="new Date()"
                    dark
                    @blur="
                      validateDateTime();
                  ...
                  />
                  <p
                    v-if="showWarning.isStartTime"
                    class="text-sm text-red-400 absolute mt-1"
                  >
                    * Enter your event start time.
                  </p>
                  <p
                    v-else-if="showWarning.dateTimePast"
                    class="text-sm text-red-400 absolute mt-1"
                  >
